...
[[request-fields]]
=== request-fields
include::{snippets}/get-me/request-fields.adoc[]
...
[[links]]
=== links
include::{snippets}/change-password/links.adoc[]
...
[[links]]
=== links
include::{snippets}/change-nickname/links.adoc[]
...
[[request-fields]]
=== request-fields
include::{snippets}/change-profile/request-fields.adoc[]
...
[[response-fields]]
=== response-fields
include::{snippets}/change-profile/response-fields.adoc[]

[[links]]
=== links
include::{snippets}/change-profile/links.adoc[]
...
[[request-fields]]
=== request-fields
include::{snippets}/change-interests/request-fields.adoc[]
...
[[response-fields]]
=== response-fields
include::{snippets}/change-interests/response-fields.adoc[]

[[links]]
=== links
include::{snippets}/change-interests/links.adoc[]
...
[[request-fields]]
=== request-fields
include::{snippets}/change-majors/request-fields.adoc[]
...
[[response-fields]]
=== response-fields
include::{snippets}/change-majors/response-fields.adoc[]

[[links]]
=== links
include::{snippets}/change-majors/links.adoc[]
